...
`,Xt=class extends lit_element_s{constructor(){super(),Object.entries(this.constructor.dependencies).forEach((([e,t])=>{this.constructor.define(e,t)}))}emit(e,t){const i=new CustomEvent(e,Wt({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(i),i}static define(e,t=this,i={}){const o=customElements.get(e);if(!o)return void customElements.define(e,class extends t{},i);let s=" (unknown version)",r=s;"version"in t&&t.version&&(s=" v"+t.version),"version"in o&&o.version&&(r=" v"+o.version)}};Xt.version="2.15.1",Xt.dependencies={},Vt([St()],Xt.prototype,"dir",2),Vt([St()],Xt.prototype,"lang",2);const ei=Math.min,ti=Math.max,ii=Math.round,oi=Math.floor,ni=e=>({x:e,y:e}),si={left:"right",right:"left",bottom:"top",top:"bottom"},ri={start:"end",end:"start"};function ai(e,t,i){return ti(e,ei(t,i))}function li(e,t){return"function"==typeof e?e(t):e}function ci(e){return e.split("-")[0]}function hi(e){return e.split("-")[1]}function pi(e){return"x"===e?"y":"x"}function di(e){return"y"===e?"height":"width"}function ui(e){return["top","bottom"].includes(ci(e))?"y":"x"}function gi(e){return pi(ui(e))}function fi(e){return e.replace(/start|end/g,(e=>ri[e]))}function mi(e){return e.replace(/left|right|bottom|top/g,(e=>si[e]))}function bi(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function vi(e){const{x:t,y:i,width:o,height:s}=e;return{width:o,height:s,top:i,left:t,right:t+o,bottom:i+s,x:t,y:i}}function yi(e,t,i){let{reference:o,floating:s}=e;const r=ui(t),a=gi(t),l=di(a),c=ci(t),h="y"===r,p=o.x+o.width/2-s.width/2,d=o.y+o.height/2-s.height/2,u=o[l]/2-s[l]/2;let g;switch(c){case"top":g={x:p,y:o.y-s.height};break;case"bottom":g={x:p,y:o.y+o.height};break;case"right":g={x:o.x+o.width,y:d};break;case"left":g={x:o.x-s.width,y:d};break;default:g={x:o.x,y:o.y}}switch(hi(t)){case"start":g[a]-=u*(i&&h?-1:1);break;case"end":g[a]+=u*(i&&h?-1:1)}return g}async function wi(e,t){var i;void 0===t&&(t={});const{x:o,y:s,platform:r,rects:a,elements:l,strategy:c}=e,{boundary:h="clippingAncestors",rootBoundary:p="viewport",elementContext:d="floating",altBoundary:u=!1,padding:g=0}=li(t,e),f=bi(g),m=l[u?"floating"===d?"reference":"floating":d],v=vi(await r.getClippingRect({element:null==(i=await(null==r.isElement?void 0:r.isElement(m)))||i?m:m.contextElement||await(null==r.getDocumentElement?void 0:r.getDocumentElement(l.floating)),boundary:h,rootBoundary:p,strategy:c})),y="floating"===d?{x:o,y:s,width:a.floating.width,height:a.floating.height}:a.reference,w=await(null==r.getOffsetParent?void 0:r.getOffsetParent(l.floating)),C=await(null==r.isElement?void 0:r.isElement(w))&&await(null==r.getScale?void 0:r.getScale(w))||{x:1,y:1},_=vi(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:y,offsetParent:w,strategy:c}):y);return{top:(v.top-_.top+f.top)/C.y,bottom:(_.bottom-v.bottom+f.bottom)/C.y,left:(v.left-_.left+f.left)/C.x,right:(_.right-v.right+f.right)/C.x}}function Ci(e){return xi(e)?(e.nodeName||"").toLowerCase():"#document"}function ki(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function _i(e){var t;return null==(t=(xi(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function xi(e){return e instanceof Node||e instanceof ki(e).Node}function $i(e){return e instanceof Element||e instanceof ki(e).Element}function Si(e){return e instanceof HTMLElement||e instanceof ki(e).HTMLElement}function Ri(e){return"undefined"!=typeof ShadowRoot&&(e instanceof ShadowRoot||e instanceof ki(e).ShadowRoot)}function Pi(e){const{overflow:t,overflowX:i,overflowY:o,display:s}=Ei(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+i)&&!["inline","contents"].includes(s)}function Ai(e){return["table","td","th"].includes(Ci(e))}function Di(e){const t=Ti(),i=Ei(e);return"none"!==i.transform||"none"!==i.perspective||!!i.containerType&&"normal"!==i.containerType||!t&&!!i.backdropFilter&&"none"!==i.backdropFilter||!t&&!!i.filter&&"none"!==i.filter||["transform","perspective","filter"].some((e=>(i.willChange||"").includes(e)))||["paint","layout","strict","content"].some((e=>(i.contain||"").includes(e)))}function Ti(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}function Li(e){return["html","body","#document"].includes(Ci(e))}function Ei(e){return ki(e).getComputedStyle(e)}function Oi(e){return $i(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.pageXOffset,scrollTop:e.pageYOffset}}function Fi(e){if("html"===Ci(e))return e;const t=e.assignedSlot||e.parentNode||Ri(e)&&e.host||_i(e);return Ri(t)?t.host:t}function Bi(e){const t=Fi(e);return Li(t)?e.ownerDocument?e.ownerDocument.body:e.body:Si(t)&&Pi(t)?t:Bi(t)}function Mi(e,t,i){var o;void 0===t&&(t=[]),void 0===i&&(i=!0);const s=Bi(e),r=s===(null==(o=e.ownerDocument)?void 0:o.body),a=ki(s);return r?t.concat(a,a.visualViewport||[],Pi(s)?s:[],a.frameElement&&i?Mi(a.frameElement):[]):t.concat(s,Mi(s,[],i))}function zi(e){const t=Ei(e);let i=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const s=Si(e),r=s?e.offsetWidth:i,a=s?e.offsetHeight:o,l=ii(i)!==r||ii(o)!==a;return l&&(i=r,o=a),{width:i,height:o,$:l}}function Ii(e){return $i(e)?e:e.contextElement}function Ui(e){const t=Ii(e);if(!Si(t))return ni(1);const i=t.getBoundingClientRect(),{width:o,height:s,$:r}=zi(t);let a=(r?ii(i.width):i.width)/o,l=(r?ii(i.height):i.height)/s;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}const Wi=ni(0);function Hi(e){const t=ki(e);return Ti()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:Wi}function Vi(e,t,i,o){void 0===t&&(t=!1),void 0===i&&(i=!1);const s=e.getBoundingClientRect(),r=Ii(e);let a=ni(1);t&&(o?$i(o)&&(a=Ui(o)):a=Ui(e));const l=function(e,t,i){return void 0===t&&(t=!1),!(!i||t&&i!==ki(e))&&t}(r,i,o)?Hi(r):ni(0);let c=(s.left+l.x)/a.x,h=(s.top+l.y)/a.y,p=s.width/a.x,d=s.height/a.y;if(r){const e=ki(r),t=o&&$i(o)?ki(o):o;let i=e,s=i.frameElement;for(;s&&o&&t!==i;){const e=Ui(s),t=s.getBoundingClientRect(),o=Ei(s),r=t.left+(s.clientLeft+parseFloat(o.paddingLeft))*e.x,a=t.top+(s.clientTop+parseFloat(o.paddingTop))*e.y;c*=e.x,h*=e.y,p*=e.x,d*=e.y,c+=r,h+=a,i=ki(s),s=i.frameElement}}return vi({width:p,height:d,x:c,y:h})}const Ni=[":popover-open",":modal"];function Gi(e){return Ni.some((t=>{try{return e.matches(t)}catch(e){return!1}}))}function ji(e){return Vi(_i(e)).left+Oi(e).scrollLeft}function qi(e,t,i){let o;if("viewport"===t)o=function(e,t){const i=ki(e),o=_i(e),s=i.visualViewport;let r=o.clientWidth,a=o.clientHeight,l=0,c=0;if(s){r=s.width,a=s.height;const e=Ti();(!e||e&&"fixed"===t)&&(l=s.offsetLeft,c=s.offsetTop)}return{width:r,height:a,x:l,y:c}}(e,i);else if("document"===t)o=function(e){const t=_i(e),i=Oi(e),o=e.ownerDocument.body,s=ti(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),r=ti(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight);let a=-i.scrollLeft+ji(e);const l=-i.scrollTop;return"rtl"===Ei(o).direction&&(a+=ti(t.clientWidth,o.clientWidth)-s),{width:s,height:r,x:a,y:l}}(_i(e));else if($i(t))o=function(e,t){const i=Vi(e,!0,"fixed"===t),o=i.top+e.clientTop,s=i.left+e.clientLeft,r=Si(e)?Ui(e):ni(1);return{width:e.clientWidth*r.x,height:e.clientHeight*r.y,x:s*r.x,y:o*r.y}}(t,i);else{const i=Hi(e);o={...t,x:t.x-i.x,y:t.y-i.y}}return vi(o)}function Qi(e,t){const i=Fi(e);return!(i===t||!$i(i)||Li(i))&&("fixed"===Ei(i).position||Qi(i,t))}function Ki(e,t,i){const o=Si(t),s=_i(t),r="fixed"===i,a=Vi(e,!0,r,t);let l={scrollLeft:0,scrollTop:0};const c=ni(0);if(o||!o&&!r)if(("body"!==Ci(t)||Pi(s))&&(l=Oi(t)),o){const e=Vi(t,!0,r,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else s&&(c.x=ji(s));return{x:a.left+l.scrollLeft-c.x,y:a.top+l.scrollTop-c.y,width:a.width,height:a.height}}function Ji(e){return"static"===Ei(e).position}function Yi(e,t){return Si(e)&&"fixed"!==Ei(e).position?t?t(e):e.offsetParent:null}function Zi(e,t){const i=ki(e);if(Gi(e))return i;if(!Si(e)){let t=Fi(e);for(;t&&!Li(t);){if($i(t)&&!Ji(t))return t;t=Fi(t)}return i}let o=Yi(e,t);for(;o&&Ai(o)&&Ji(o);)o=Yi(o,t);return o&&Li(o)&&Ji(o)&&!Di(o)?i:o||function(e){let t=Fi(e);for(;Si(t)&&!Li(t);){if(Di(t))return t;t=Fi(t)}return null}(e)||i}const Xi={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:i,offsetParent:o,strategy:s}=e;const r="fixed"===s,a=_i(o),l=!!t&&Gi(t.floating);if(o===a||l&&r)return i;let c={scrollLeft:0,scrollTop:0},h=ni(1);const p=ni(0),d=Si(o);if((d||!d&&!r)&&(("body"!==Ci(o)||Pi(a))&&(c=Oi(o)),Si(o))){const e=Vi(o);h=Ui(o),p.x=e.x+o.clientLeft,p.y=e.y+o.clientTop}return{width:i.width*h.x,height:i.height*h.y,x:i.x*h.x-c.scrollLeft*h.x+p.x,y:i.y*h.y-c.scrollTop*h.y+p.y}},getDocumentElement:_i,getClippingRect:function(e){let{element:t,boundary:i,rootBoundary:o,strategy:s}=e;const r=[..."clippingAncestors"===i?Gi(t)?[]:function(e,t){const i=t.get(e);if(i)return i;let o=Mi(e,[],!1).filter((e=>$i(e)&&"body"!==Ci(e))),s=null;const r="fixed"===Ei(e).position;let a=r?Fi(e):e;for(;$i(a)&&!Li(a);){const t=Ei(a),i=Di(a);i||"fixed"!==t.position||(s=null),(r?!i&&!s:!i&&"static"===t.position&&s&&["absolute","fixed"].includes(s.position)||Pi(a)&&!i&&Qi(e,a))?o=o.filter((e=>e!==a)):s=t,a=Fi(a)}return t.set(e,o),o}(t,this._c):[].concat(i),o],a=r[0],l=r.reduce(((e,i)=>{const o=qi(t,i,s);return e.top=ti(o.top,e.top),e.right=ei(o.right,e.right),e.bottom=ei(o.bottom,e.bottom),e.left=ti(o.left,e.left),e}),qi(t,a,s));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}},getOffsetParent:Zi,getElementRects:async function(e){const t=this.getOffsetParent||Zi,i=this.getDimensions,o=await i(e.floating);return{reference:Ki(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:i}=zi(e);return{width:t,height:i}},getScale:Ui,isElement:$i,isRTL:function(e){return"rtl"===Ei(e).direction}};function eo(e,t,i,o){void 0===o&&(o={});const{ancestorScroll:s=!0,ancestorResize:r=!0,elementResize:a="function"==typeof ResizeObserver,layoutShift:l="function"==typeof IntersectionObserver,animationFrame:c=!1}=o,h=Ii(e),p=s||r?[...h?Mi(h):[],...Mi(t)]:[];p.forEach((e=>{s&&e.addEventListener("scroll",i,{passive:!0}),r&&e.addEventListener("resize",i)}));const d=h&&l?function(e,t){let i,o=null;const s=_i(e);function r(){var e;clearTimeout(i),null==(e=o)||e.disconnect(),o=null}return function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),r();const{left:h,top:p,width:d,height:u}=e.getBoundingClientRect();if(l||t(),!d||!u)return;const g={rootMargin:-oi(p)+"px "+-oi(s.clientWidth-(h+d))+"px "+-oi(s.clientHeight-(p+u))+"px "+-oi(h)+"px",threshold:ti(0,ei(1,c))||1};let f=!0;function m(e){const t=e[0].intersectionRatio;if(t!==c){if(!f)return a();t?a(!1,t):i=setTimeout((()=>{a(!1,1e-7)}),1e3)}f=!1}try{o=new IntersectionObserver(m,{...g,root:s.ownerDocument})}catch(e){o=new IntersectionObserver(m,g)}o.observe(e)}(!0),r}(h,i):null;let u,g=-1,f=null;a&&(f=new ResizeObserver((e=>{let[o]=e;o&&o.target===h&&f&&(f.unobserve(t),cancelAnimationFrame(g),g=requestAnimationFrame((()=>{var e;null==(e=f)||e.observe(t)}))),i()})),h&&!c&&f.observe(h),f.observe(t));let m=c?Vi(e):null;return c&&function t(){const o=Vi(e);!m||o.x===m.x&&o.y===m.y&&o.width===m.width&&o.height===m.height||i();m=o,u=requestAnimationFrame(t)}(),i(),()=>{var e;p.forEach((e=>{s&&e.removeEventListener("scroll",i),r&&e.removeEventListener("resize",i)})),null==d||d(),null==(e=f)||e.disconnect(),f=null,c&&cancelAnimationFrame(u)}}const to=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var i,o;const{x:s,y:r,placement:a,middlewareData:l}=t,c=await async function(e,t){const{placement:i,platform:o,elements:s}=e,r=await(null==o.isRTL?void 0:o.isRTL(s.floating)),a=ci(i),l=hi(i),c="y"===ui(i),h=["left","top"].includes(a)?-1:1,p=r&&c?-1:1,d=li(t,e);let{mainAxis:u,crossAxis:g,alignmentAxis:f}="number"==typeof d?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...d};return l&&"number"==typeof f&&(g="end"===l?-1*f:f),c?{x:g*p,y:u*h}:{x:u*h,y:g*p}}(t,e);return a===(null==(i=l.offset)?void 0:i.placement)&&null!=(o=l.arrow)&&o.alignmentOffset?{}:{x:s+c.x,y:r+c.y,data:{...c,placement:a}}}}},io=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:i,y:o,placement:s}=t,{mainAxis:r=!0,crossAxis:a=!1,limiter:l={fn:e=>{let{x:t,y:i}=e;return{x:t,y:i}}},...c}=li(e,t),h={x:i,y:o},p=await wi(t,c),d=ui(ci(s)),u=pi(d);let g=h[u],f=h[d];if(r){const e="y"===u?"bottom":"right";g=ai(g+p["y"===u?"top":"left"],g,g-p[e])}if(a){const e="y"===d?"bottom":"right";f=ai(f+p["y"===d?"top":"left"],f,f-p[e])}const m=l.fn({...t,[u]:g,[d]:f});return{...m,data:{x:m.x-i,y:m.y-o}}}}},oo=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var i,o;const{placement:s,middlewareData:r,rects:a,initialPlacement:l,platform:c,elements:h}=t,{mainAxis:p=!0,crossAxis:d=!0,fallbackPlacements:u,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...v}=li(e,t);if(null!=(i=r.arrow)&&i.alignmentOffset)return{};const y=ci(s),w=ci(l)===l,C=await(null==c.isRTL?void 0:c.isRTL(h.floating)),_=u||(w||!m?[mi(l)]:function(e){const t=mi(e);return[fi(e),t,fi(t)]}(l));u||"none"===f||_.push(...function(e,t,i,o){const s=hi(e);let r=function(e,t,i){const o=["left","right"],s=["right","left"],r=["top","bottom"],a=["bottom","top"];switch(e){case"top":case"bottom":return i?t?s:o:t?o:s;case"left":case"right":return t?r:a;default:return[]}}(ci(e),"start"===i,o);return s&&(r=r.map((e=>e+"-"+s)),t&&(r=r.concat(r.map(fi)))),r}(l,m,f,C));const x=[l,..._],$=await wi(t,v),S=[];let P=(null==(o=r.flip)?void 0:o.overflows)||[];if(p&&S.push($[y]),d){const e=function(e,t,i){void 0===i&&(i=!1);const o=hi(e),s=gi(e),r=di(s);let a="x"===s?o===(i?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[r]>t.floating[r]&&(a=mi(a)),[a,mi(a)]}(s,a,C);S.push($[e[0]],$[e[1]])}if(P=[...P,{placement:s,overflows:S}],!S.every((e=>e<=0))){var A,D;const e=((null==(A=r.flip)?void 0:A.index)||0)+1,t=x[e];if(t)return{data:{index:e,overflows:P},reset:{placement:t}};let i=null==(D=P.filter((e=>e.overflows[0]<=0)).sort(((e,t)=>e.overflows[1]-t.overflows[1]))[0])?void 0:D.placement;if(!i)switch(g){case"bestFit":{var T;const e=null==(T=P.map((e=>[e.placement,e.overflows.filter((e=>e>0)).reduce(((e,t)=>e+t),0)])).sort(((e,t)=>e[1]-t[1]))[0])?void 0:T[0];e&&(i=e);break}case"initialPlacement":i=l}if(s!==i)return{reset:{placement:i}}}return{}}}},no=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){const{placement:i,rects:o,platform:s,elements:r}=t,{apply:a=(()=>{}),...l}=li(e,t),c=await wi(t,l),h=ci(i),p=hi(i),d="y"===ui(i),{width:u,height:g}=o.floating;let f,m;"top"===h||"bottom"===h?(f=h,m=p===(await(null==s.isRTL?void 0:s.isRTL(r.floating))?"start":"end")?"left":"right"):(m=h,f="end"===p?"top":"bottom");const v=g-c.top-c.bottom,y=u-c.left-c.right,w=ei(g-c[f],v),C=ei(u-c[m],y),_=!t.middlewareData.shift;let x=w,$=C;if(d?$=p||_?ei(C,y):y:x=p||_?ei(w,v):v,_&&!p){const e=ti(c.left,0),t=ti(c.right,0),i=ti(c.top,0),o=ti(c.bottom,0);d?$=u-2*(0!==e||0!==t?e+t:ti(c.left,c.right)):x=g-2*(0!==i||0!==o?i+o:ti(c.top,c.bottom))}await a({...t,availableWidth:$,availableHeight:x});const S=await s.getDimensions(r.floating);return u!==S.width||g!==S.height?{reset:{rects:!0}}:{}}}},so=e=>({name:"arrow",options:e,async fn(t){const{x:i,y:o,placement:s,rects:r,platform:a,elements:l,middlewareData:c}=t,{element:h,padding:p=0}=li(e,t)||{};if(null==h)return{};const d=bi(p),u={x:i,y:o},g=gi(s),f=di(g),m=await a.getDimensions(h),v="y"===g,y=v?"top":"left",w=v?"bottom":"right",C=v?"clientHeight":"clientWidth",_=r.reference[f]+r.reference[g]-u[g]-r.floating[f],x=u[g]-r.reference[g],$=await(null==a.getOffsetParent?void 0:a.getOffsetParent(h));let S=$?$[C]:0;S&&await(null==a.isElement?void 0:a.isElement($))||(S=l.floating[C]||r.floating[f]);const P=_/2-x/2,A=S/2-m[f]/2-1,D=ei(d[y],A),T=ei(d[w],A),E=D,O=S-m[f]-T,F=S/2-m[f]/2+P,B=ai(E,F,O),z=!c.arrow&&null!=hi(s)&&F!==B&&r.reference[f]/2-(F<E?D:T)-m[f]/2<0,U=z?F<E?F-E:F-O:0;return{[g]:u[g]+U,data:{[g]:B,centerOffset:F-B-U,...z&&{alignmentOffset:U}},reset:z}}}),ro=(e,t,i)=>{const o=new Map,s={platform:Xi,...i},r={...s.platform,_c:o};return(async(e,t,i)=>{const{placement:o="bottom",strategy:s="absolute",middleware:r=[],platform:a}=i,l=r.filter(Boolean),c=await(null==a.isRTL?void 0:a.isRTL(t));let h=await a.getElementRects({reference:e,floating:t,strategy:s}),{x:p,y:d}=yi(h,o,c),u=o,g={},f=0;for(let i=0;i<l.length;i++){const{name:r,fn:m}=l[i],{x:v,y,data:w,reset:C}=await m({x:p,y:d,initialPlacement:o,placement:u,strategy:s,middlewareData:g,rects:h,platform:a,elements:{reference:e,floating:t}});p=null!=v?v:p,d=null!=y?y:d,g={...g,[r]:{...g[r],...w}},C&&f<=50&&(f++,"object"==typeof C&&(C.placement&&(u=C.placement),C.rects&&(h=!0===C.rects?await a.getElementRects({reference:e,floating:t,strategy:s}):C.rects),({x:p,y:d}=yi(h,u,c))),i=-1)}return{x:p,y:d,placement:u,strategy:s,middlewareData:g}})(e,t,{...s,platform:r})},ao=1;class directive_i{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const lo=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends directive_i{constructor(e){if(super(e),e.type!==ao||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const i=e.element.classList;for(const e of this.st)e in t||(i.remove(e),this.st.delete(e));for(const e in t){const o=!!t[e];o===this.st.has(e)||this.nt?.has(e)||(o?(i.add(e),this.st.add(e)):(i.remove(e),this.st.delete(e)))}return gt}});function co(e){return po(e)}function ho(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function po(e){for(let t=e;t;t=ho(t))if(t instanceof Element&&"none"===getComputedStyle(t).display)return null;for(let t=ho(e);t;t=ho(t)){if(!(t instanceof Element))continue;const e=getComputedStyle(t);if("contents"!==e.display){if("static"!==e.position||"none"!==e.filter)return t;if("BODY"===t.tagName)return t}}return null}var uo=class extends Xt{constructor(){super(...arguments),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect();let i=0,o=0,s=0,r=0,a=0,l=0,c=0,h=0;this.placement.includes("top")||this.placement.includes("bottom")?e.top<t.top?(i=e.left,o=e.bottom,s=e.right,r=e.bottom,a=t.left,l=t.top,c=t.right,h=t.top):(i=t.left,o=t.bottom,s=t.right,r=t.bottom,a=e.left,l=e.top,c=e.right,h=e.top):e.left<t.left?(i=e.right,o=e.top,s=t.left,r=t.top,a=e.right,l=e.bottom,c=t.left,h=t.bottom):(i=t.right,o=t.top,s=e.left,r=e.top,a=t.right,l=t.bottom,c=e.left,h=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${i}px`),this.style.setProperty("--hover-bridge-top-left-y",`${o}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${r}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${a}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${h}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||function(e){return null!==e&&"object"==typeof e&&"getBoundingClientRect"in e&&(!("contextElement"in e)||e instanceof Element)}(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.start()}start(){this.anchorEl&&(this.cleanup=eo(this.anchorEl,this.popup,(()=>{this.reposition()})))}async stop(){return new Promise((e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame((()=>e()))):e()}))}reposition(){if(!this.active||!this.anchorEl)return;const e=[to({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(no({apply:({rects:e})=>{const t="width"===this.sync||"both"===this.sync,i="height"===this.sync||"both"===this.sync;this.popup.style.width=t?`${e.reference.width}px`:"",this.popup.style.height=i?`${e.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(oo({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(io({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(no({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${t}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(so({element:this.arrowEl,padding:this.arrowPadding}));const t="absolute"===this.strategy?e=>Xi.getOffsetParent(e,co):Xi.getOffsetParent;ro(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:Ht(Wt({},Xi),{getOffsetParent:t})}).then((({x:e,y:t,middlewareData:i,placement:o})=>{const s="rtl"===getComputedStyle(this).direction,r={top:"bottom",right:"left",bottom:"top",left:"right"}[o.split("-")[0]];if(this.setAttribute("data-current-placement",o),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){const e=i.arrow.x,t=i.arrow.y;let o="",a="",l="",c="";if("start"===this.arrowPlacement){const i="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";o="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",a=s?i:"",c=s?"":i}else if("end"===this.arrowPlacement){const i="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";a=s?"":i,c=s?i:"",l="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(c="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":"",o="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":""):(c="number"==typeof e?`${e}px`:"",o="number"==typeof t?`${t}px`:"");Object.assign(this.arrowEl.style,{top:o,right:a,bottom:l,left:c,[r]:"calc(var(--arrow-size-diagonal) * -1)"})}})),requestAnimationFrame((()=>this.updateHoverBridge())),this.emit("sl-reposition")}render(){return ut`
    ...
    `}};function go(e,t){return new Promise((i=>{e.addEventListener(t,(function o(s){s.target===e&&(e.removeEventListener(t,o),i())}))}))}function fo(e,t,i){return new Promise((o=>{if((null==i?void 0:i.duration)===1/0)throw new Error("Promise-based animations must be finite.");const s=e.animate(t,Ht(Wt({},i),{duration:bo()?0:i.duration}));s.addEventListener("cancel",o,{once:!0}),s.addEventListener("finish",o,{once:!0})}))}function mo(e){return(e=e.toString().toLowerCase()).indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?1e3*parseFloat(e):parseFloat(e)}function bo(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function vo(e){return Promise.all(e.getAnimations().map((e=>new Promise((t=>{e.cancel(),requestAnimationFrame(t)})))))}uo.styles=[Zt,Yt],Vt([Pt(".popup")],uo.prototype,"popup",2),Vt([Pt(".popup__arrow")],uo.prototype,"arrowEl",2),Vt([St()],uo.prototype,"anchor",2),Vt([St({type:Boolean,reflect:!0})],uo.prototype,"active",2),Vt([St({reflect:!0})],uo.prototype,"placement",2),Vt([St({reflect:!0})],uo.prototype,"strategy",2),Vt([St({type:Number})],uo.prototype,"distance",2),Vt([St({type:Number})],uo.prototype,"skidding",2),Vt([St({type:Boolean})],uo.prototype,"arrow",2),Vt([St({attribute:"arrow-placement"})],uo.prototype,"arrowPlacement",2),Vt([St({attribute:"arrow-padding",type:Number})],uo.prototype,"arrowPadding",2),Vt([St({type:Boolean})],uo.prototype,"flip",2),Vt([St({attribute:"flip-fallback-placements",converter:{fromAttribute:e=>e.split(" ").map((e=>e.trim())).filter((e=>""!==e)),toAttribute:e=>e.join(" ")}})],uo.prototype,"flipFallbackPlacements",2),Vt([St({attribute:"flip-fallback-strategy"})],uo.prototype,"flipFallbackStrategy",2),Vt([St({type:Object})],uo.prototype,"flipBoundary",2),Vt([St({attribute:"flip-padding",type:Number})],uo.prototype,"flipPadding",2),Vt([St({type:Boolean})],uo.prototype,"shift",2),Vt([St({type:Object})],uo.prototype,"shiftBoundary",2),Vt([St({attribute:"shift-padding",type:Number})],uo.prototype,"shiftPadding",2),Vt([St({attribute:"auto-size"})],uo.prototype,"autoSize",2),Vt([St()],uo.prototype,"sync",2),Vt([St({type:Object})],uo.prototype,"autoSizeBoundary",2),Vt([St({attribute:"auto-size-padding",type:Number})],uo.prototype,"autoSizePadding",2),Vt([St({attribute:"hover-bridge",type:Boolean})],uo.prototype,"hoverBridge",2);const yo=new Set,wo=new MutationObserver(So),Co=new Map;let ko,_o=document.documentElement.dir||"ltr",xo=document.documentElement.lang||navigator.language;function $o(...e){e.map((e=>{const t=e.$code.toLowerCase();Co.has(t)?Co.set(t,Object.assign(Object.assign({},Co.get(t)),e)):Co.set(t,e),ko||(ko=e)})),So()}function So(){_o=document.documentElement.dir||"ltr",xo=document.documentElement.lang||navigator.language,[...yo.keys()].map((e=>{"function"==typeof e.requestUpdate&&e.requestUpdate()}))}wo.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]});class LocalizeController{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){yo.add(this.host)}hostDisconnected(){yo.delete(this.host)}dir(){return`${this.host.dir||_o}`.toLowerCase()}lang(){return`${this.host.lang||xo}`.toLowerCase()}getTranslationData(e){var t,i;const o=new Intl.Locale(e.replace(/_/g,"-")),s=null==o?void 0:o.language.toLowerCase(),r=null!==(i=null===(t=null==o?void 0:o.region)||void 0===t?void 0:t.toLowerCase())&&void 0!==i?i:"";return{locale:o,language:s,region:r,primary:Co.get(`${s}-${r}`),secondary:Co.get(s)}}exists(e,t){var i;const{primary:o,secondary:s}=this.getTranslationData(null!==(i=t.lang)&&void 0!==i?i:this.lang());return t=Object.assign({includeFallback:!1},t),!!(o&&o[e]||s&&s[e]||t.includeFallback&&ko&&ko[e])}term(e,...t){const{primary:i,secondary:o}=this.getTranslationData(this.lang());let s;if(i&&i[e])s=i[e];else if(o&&o[e])s=o[e];else{if(!ko||!ko[e])return String(e);s=ko[e]}return"function"==typeof s?s(...t):s}date(e,t){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),t).format(e)}number(e,t){return e=Number(e),isNaN(e)?"":new Intl.NumberFormat(this.lang(),t).format(e)}relativeTime(e,t,i){return new Intl.RelativeTimeFormat(this.lang(),i).format(e,t)}}var Ro={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>0===e?"No options selected":1===e?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"};$o(Ro);var Po=Ro,Ao=class extends LocalizeController{};function Do(e,t){const i=Wt({waitUntilFirstUpdate:!1},t);return(t,o)=>{const{update:s}=t,r=Array.isArray(e)?e:[e];t.update=function(e){r.forEach((t=>{const s=t;if(e.has(s)){const t=e.get(s),r=this[s];t!==r&&(i.waitUntilFirstUpdate&&!this.hasUpdated||this[o](t,r))}})),s.call(this,e)}}}$o(Po);var To=class extends Xt{constructor(){super(),this.localize=new Ao(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=mo(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.show()),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=mo(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.hide()),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;null==(e=this.closeWatcher)||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?(null==(e=this.closeWatcher)||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await vo(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:t,options:i}=Kt(this,"tooltip.show",{dir:this.localize.dir()});await fo(this.popup.popup,t,i),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),null==(t=this.closeWatcher)||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await vo(this.body);const{keyframes:e,options:i}=Kt(this,"tooltip.hide",{dir:this.localize.dir()});await fo(this.popup.popup,e,i),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,go(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,go(this,"sl-after-hide")}render(){return ut`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
    ...
    `}};To.styles=[Zt,Jt],To.dependencies={"sl-popup":uo},Vt([Pt("slot:not([name])")],To.prototype,"defaultSlot",2),Vt([Pt(".tooltip__body")],To.prototype,"body",2),Vt([Pt("sl-popup")],To.prototype,"popup",2),Vt([St()],To.prototype,"content",2),Vt([St()],To.prototype,"placement",2),Vt([St({type:Boolean,reflect:!0})],To.prototype,"disabled",2),Vt([St({type:Number})],To.prototype,"distance",2),Vt([St({type:Boolean,reflect:!0})],To.prototype,"open",2),Vt([St({type:Number})],To.prototype,"skidding",2),Vt([St()],To.prototype,"trigger",2),Vt([St({type:Boolean})],To.prototype,"hoist",2),Vt([Do("open",{waitUntilFirstUpdate:!0})],To.prototype,"handleOpenChange",1),Vt([Do(["content","distance","hoist","placement","skidding"])],To.prototype,"handleOptionsChange",1),Vt([Do("disabled")],To.prototype,"handleDisabledChange",1),Qt("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),Qt("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});To.define("sl-tooltip");var Lo=Object.defineProperty,Eo=Object.getOwnPropertyDescriptor,Oo=(e,t,i,o)=>{for(var s,r=o>1?void 0:o?Eo(t,i):t,a=e.length-1;a>=0;a--)(s=e[a])&&(r=(o?s(t,i,r):s(r))||r);return o&&r&&Lo(t,i,r),r};Qt("tooltip.show",null),Qt("tooltip.hide",null);let Fo=class extends lit_element_s{constructor(){super(...arguments),this.placement="bottom",this.disabled=!1}firstUpdated(){this.observer=new MutationObserver((e=>{for(const t of e)if("attributes"===t.type&&"data-current-placement"===t.attributeName){const e=t.target.getAttribute("data-current-placement");e?this.setAttribute("data-current-placement",e):this.removeAttribute("data-current-placement")}}));const e=this.shadowRoot?.querySelector("sl-tooltip")?.shadowRoot;this.observer.observe(e,{attributes:!0,attributeFilter:["data-current-placement"],subtree:!0})}disconnectedCallback(){this.observer?.disconnect()}render(){return ut`<sl-tooltip
			.placement=${this.placement}
	...
	`,Oo([St()],Fo.prototype,"content",2),Oo([St({reflect:!0})],Fo.prototype,"placement",2),Oo([St({type:Boolean})],Fo.prototype,"disabled",2),Oo([St({type:Number})],Fo.prototype,"distance",2),Oo([St({type:Boolean})],Fo.prototype,"hoist",2),Fo=Oo([_t("gl-tooltip")],Fo);var Bo=Object.defineProperty,Mo=Object.getOwnPropertyDescriptor,zo=(e,t,i,o)=>{for(var s,r=o>1?void 0:o?Mo(t,i):t,a=e.length-1;a>=0;a--)(s=e[a])&&(r=(o?s(t,i,r):s(r))||r);return o&&r&&Bo(t,i,r),r};let Io=class extends lit_element_s{constructor(){super(...arguments),this.disabled=!1,this.full=!1}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return this.tooltip?ut`<gl-tooltip .content=${this.tooltip}>${this.renderControl()}</gl-tooltip>`:this.querySelectorAll('[slot="tooltip"]').length>0?ut`<gl-tooltip>
				${this.renderControl()}
	...
	`,Ho([St()],No.prototype,"icon",2),Ho([St()],No.prototype,"modifier",2),Ho([St({type:Number})],No.prototype,"size",2),Ho([St()],No.prototype,"flip",2),Ho([St()],No.prototype,"rotate",2),No=Ho([_t("code-icon")],No);var Go=(e=>(e.Free="free",e.FreePlus="free+",e.Pro="pro",e.Teams="teams",e.Enterprise="enterprise",e))(Go||{}),jo=(e=>(e[e.VerificationRequired=-1]="VerificationRequired",e[e.Free=0]="Free",e[e.FreeInPreviewTrial=1]="FreeInPreviewTrial",e[e.FreePreviewTrialExpired=2]="FreePreviewTrialExpired",e[e.FreePlusInTrial=3]="FreePlusInTrial",e[e.FreePlusTrialExpired=4]="FreePlusTrialExpired",e[e.FreePlusTrialReactivationEligible=5]="FreePlusTrialReactivationEligible",e[e.Paid=6]="Paid",e))(jo||{});function qo(e){switch(e){case"free+":return"GitKraken Free";case"pro":return"GitKraken Pro";case"teams":return"GitKraken Teams";case"enterprise":return"GitKraken Enterprise";default:return"GitKraken"}}function Qo(e,t){return Ko(e.plan.effective.expiresOn,t)}function Ko(e,t){return null!=e?function(e,t,i,o){const s=("number"==typeof t?t:t.getTime())-("number"==typeof e?e:e.getTime()),r=o??Math.floor;switch(i){case"days":return r(s/864e5);case"hours":return r(s/36e5);case"minutes":return r(s/6e4);case"seconds":return r(s/1e3);default:return s}}(Date.now(),new Date(e),t,Math.round):void 0}uo.define("sl-popup");const Jo=new WeakMap;function Yo(e,t){return function(i,o,s){let r=Jo.get(i.constructor);null==r&&Jo.set(i.constructor,r=[]),r.push({method:s.value,keys:Array.isArray(e)?e:[e],afterFirstUpdate:t?.afterFirstUpdate??!1})}}class GlElement extends lit_element_s{emit(e,t,i){const o=new CustomEvent(e,{bubbles:!0,cancelable:!1,composed:!0,...i,detail:t});return this.dispatchEvent(o),o}update(e){const t=Jo.get(this.constructor);if(null!=t)for(const{keys:i,method:o,afterFirstUpdate:s}of t){if(s&&!this.hasUpdated)continue;const t=i.filter((t=>e.has(t)));t.length&&o.call(this,t)}super.update(e)}}var Zo=Object.defineProperty,Xo=Object.getOwnPropertyDescriptor,en=(e,t,i,o)=>{for(var s,r=o>1?void 0:o?Xo(t,i):t,a=e.length-1;a>=0;a--)(s=e[a])&&(r=(o?s(t,i,r):s(r))||r);return o&&r&&Zo(t,i,r),r};let tn=class extends GlElement{constructor(){super(),this.placement="bottom",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleTriggerBlur=e=>{if(this.open&&this.hasTrigger("focus")){if(e.composedPath().includes(this))return;this.hide()}},this.handleTriggerClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleTriggerFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handlePopupBlur=e=>{e.composedPath().includes(this)||this.hide()},this.handleWebviewBlur=()=>{this.hide()},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);const e=A(getComputedStyle(this).getPropertyValue("--show-delay"));this.hoverTimeout=setTimeout((()=>this.show()),e)}},this.handleMouseOut=e=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);const t=e.composedPath();if(t[t.length-2]===this)return;if(this.hasPopupFocus())return;const i=A(getComputedStyle(this).getPropertyValue("--hide-delay"));this.hoverTimeout=setTimeout((()=>this.hide()),i)}},this.addEventListener("blur",this.handleTriggerBlur,!0),this.addEventListener("focus",this.handleTriggerFocus,!0),this.addEventListener("click",this.handleTriggerClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){this.closeWatcher?.destroy(),document.removeEventListener("focusin",this.handlePopupBlur),window.removeEventListener("webview-blur",this.handleWebviewBlur,!1),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasPopupFocus(){return this.matches(':has([slot="content"]:focus-within)')}hasTrigger(e){return this.trigger.split(" ").includes(e)}handleOpenChange(){if(this.open){if(this.disabled)return;this.emit("gl-popover-show"),"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("focusin",this.handlePopupBlur),window.addEventListener("webview-blur",this.handleWebviewBlur,!1),this.body.hidden=!1,this.popup.active=!0,this.popup.reposition(),this.emit("gl-popover-after-show")}else document.removeEventListener("focusin",this.handlePopupBlur),window.removeEventListener("webview-blur",this.handleWebviewBlur,!1),this.emit("gl-popover-hide"),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),this.popup.active=!1,this.body.hidden=!0,this.emit("gl-popover-after-hide")}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,D(this,"gl-popover-after-show")}async hide(){if(this.open)return this.open=!1,D(this,"gl-popover-after-hide")}render(){return ut`<sl-popup
		...
		</sl-popup>`}};tn.shadowRootOptions={...lit_element_s.shadowRootOptions,delegatesFocus:!0},tn.styles=De`
		:host {
			--hide-delay: 0ms;
			--show-delay: 500ms;
	...
	`,en([Pt("#popover")],tn.prototype,"body",2),en([Pt("sl-popup")],tn.prototype,"popup",2),en([St({reflect:!0})],tn.prototype,"placement",2),en([St({type:Boolean,reflect:!0})],tn.prototype,"disabled",2),en([St({type:Number})],tn.prototype,"distance",2),en([St({reflect:!0,type:Boolean})],tn.prototype,"open",2),en([St({type:Number})],tn.prototype,"skidding",2),en([St()],tn.prototype,"trigger",2),en([St({type:Boolean})],tn.prototype,"hoist",2),en([Yo("open",{afterFirstUpdate:!0})],tn.prototype,"handleOpenChange",1),en([Yo(["distance","hoist","placement","skidding"])],tn.prototype,"handleOptionsChange",1),en([Yo("disabled")],tn.prototype,"handleDisabledChange",1),tn=en([_t("gl-popover")],tn);var on=Object.defineProperty,nn=Object.getOwnPropertyDescriptor,sn=(e,t,i,o)=>{for(var s,r=o>1?void 0:o?nn(t,i):t,a=e.length-1;a>=0;a--)(s=e[a])&&(r=(o?s(t,i,r):s(r))||r);return o&&r&&on(t,i,r),r};let rn=class extends lit_element_s{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){return null==this.subscription?0:Qo(this.subscription,"days")??0}get state(){return this.subscription?.state}render(){return ut`
		...
		`}renderBadge(){const e=this.preview?"Preview":"Pro";if(null!=this.subscription){if(this.state===jo.VerificationRequired)return ut`${e} <code-icon class="badge-icon" icon="warning" size="10"></code-icon>`;if(i=this.subscription,"free"!==(o=i.plan.actual.id)&&"free+"!==o||this.cloud&&null!=this.subscription.account)return ut`${e} <code-icon class="badge-icon" icon="check" size="10"></code-icon>`;if(null!=(t=this.state)&&(1===t||3===t))return ut`${e} <code-icon class="badge-icon" icon="clock" size="10"></code-icon>`}var t,i,o;return this.cloud?ut`${e}<span class="badge-icon">☁️</span>`:e}renderPopoverHeader(){const e=ut`<span class="popup-title"
			>${this.preview?"Preview feature":"Pro feature"}${this.cloud?" ☁️":""}</span
		>`;return this.state===jo.Paid?ut`<div class="popup-header">${e}</div>`:this.cloud?this.preview?ut`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires a paid plan for use on privately-hosted repos</span>
		</div>`}renderPopoverContent(){if(null==this.subscription)return ft;let e;switch(this.state){case jo.Paid:e=ut`<p>
					Your
					<gl-tooltip hoist content="Show Account view">
						<a href="${an(N.ShowAccountView,void 0)}"
							>${qo(this.subscription?.plan.actual.id??Go.Pro)}</a
						>
					</gl-tooltip>
					plan provides access to all Pro features.
				</p>`;break;case jo.VerificationRequired:e=ut`<p>You must verify your email before you can access Pro features.</p>
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${an(N.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${an(N.PlusValidate,this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					</div>`;break;case jo.FreePlusInTrial:{const t=this.daysRemaining;e=ut`<p>
						You have
						<strong>${t<1?"<1 day":q("day",t,{infix:" more "})} left</strong>
						in your Pro trial. Once your trial ends, you will only be able to use Pro features on
						publicly-hosted repos.
					</p>
					${this.renderUpgradeActions()}`;break}case jo.FreePlusTrialExpired:e=ut`<p>
						Your Pro trial as ended. You can now only use Pro features on publicly-hosted repos.
					</p>
					${this.renderUpgradeActions(ut`<p>Please upgrade for full access to Pro features:</p>`)}`;break;case jo.FreePlusTrialReactivationEligible:e=ut`<p>
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${an(N.PlusReactivateProTrial,this.source)}"
							>Reactivate Pro Trial</gl-button
						>
					</div>`;break;default:if(!this.cloud&&this.state===jo.FreeInPreviewTrial){const t=this.daysRemaining;e=ut`<p>
							You have
							<strong>${t<1?"<1 day":q("day",t,{infix:" more "})} left</strong>
							to preview
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${an(N.PlusSignUp,this.source)}"
				>Start 7-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${an(N.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){return ut`<div class="actions">
			${e??ft}
			<gl-button
				appearance="primary"
				density="tight"
				href="${an(N.PlusUpgrade,this.source)}"
				>Upgrade to Pro</gl-button
			>
			<p class="special">Special: <b>50% off first seat of Pro</b> — only $4/month!<br /></p>
		</div>`}};function an(e,t){return`command:${e}${t?`?${encodeURIComponent(JSON.stringify(t))}`:""}`}rn.styles=[Tt,Lt,De`
			:host {
				/* position: relative; */
				display: inline-block;
